...
- [x] 실패 모드 명세: WriteShard retry/backoff/give-up, pending migration TTL orphan cleanup, DstNode disk-full circuit breaker
- [x] Structured logging: component="balancer" tag + phase field
