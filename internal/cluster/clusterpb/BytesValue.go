...
func (rcv *BytesValue) VBytes(j int) byte {
...
func (rcv *BytesValue) VBytesLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(4))
	if o != 0 {
...
func (rcv *BytesValue) VBytesBytes() []byte {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(4))
	if o != 0 {
...
func (rcv *BytesValue) MutateVBytes(j int, n byte) bool {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(4))
	if o != 0 {
		a := rcv._tab.Vector(o)
...
func BytesValueAddVBytes(builder *flatbuffers.Builder, vBytes flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(vBytes), 0)
}
func BytesValueStartVBytesVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
