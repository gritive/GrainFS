...
func byteIdentityMetaFSMFixtures(t *testing.T) map[string]*MetaFSM {
	...
	// emptyFSM: all-empty vectors, nil activePlan, default cluster config.
	emptyFSM := empty()
	...
	// withPlan: active rebalance plan present (exercises the conditional
	// AddActivePlan add).
	withPlan := empty()
	withPlan.activePlan = &RebalancePlan{
		PlanID: "p0", GroupID: "g0", FromNode: "n0", ToNode: "n1",
		CreatedAt: time.Unix(1700000123, 0),
	}
...
var goldenMetaSnapshotFB = map[string]string{
	...
	"with_plan":    "",
}
