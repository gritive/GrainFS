...
func TestStore_AppendAndQuery(t *testing.T) {
	...
	events := []eventstore.Event{
		{Type: eventstore.EventTypeS3, Action: eventstore.EventActionPut, Bucket: "photos", Key: "img.jpg", Size: 1024},
		{Type: eventstore.EventTypeS3, Action: eventstore.EventActionGet, Bucket: "photos", Key: "img.jpg"},
