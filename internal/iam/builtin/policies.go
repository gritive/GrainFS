...
var builtinDocs = map[string][]byte{
	"readonly":     []byte(`{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Action":["s3:GetObject","s3:HeadObject","s3:ListBucket","s3:GetBucketLocation","s3:GetBucketVersioning","s3:ListBucketVersions","s3:GetBucketObjectLockConfiguration","s3:GetObjectRetention","s3:GetObjectTagging","iceberg:GetCatalogConfig","iceberg:ListNamespaces","iceberg:LoadNamespace","iceberg:HeadNamespace","iceberg:ListTables","iceberg:LoadTable","iceberg:HeadTable"],"Resource":"*"}]}`),
	"readwrite":    []byte(`{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Action":["s3:GetObject","s3:HeadObject","s3:ListBucket","s3:GetBucketLocation","s3:GetBucketVersioning","s3:PutBucketVersioning","s3:ListBucketVersions","s3:GetBucketObjectLockConfiguration","s3:GetObjectRetention","s3:PutObjectRetention","s3:PutObject","s3:DeleteObject","s3:CopyObject","s3:AbortMultipartUpload","s3:ListMultipartUploads","s3:GetObjectTagging","s3:PutObjectTagging","s3:DeleteObjectTagging","iceberg:GetCatalogConfig","iceberg:ListNamespaces","iceberg:LoadNamespace","iceberg:HeadNamespace","iceberg:ListTables","iceberg:LoadTable","iceberg:HeadTable","iceberg:CreateNamespace","iceberg:CreateTable","iceberg:CommitTable","iceberg:DeleteTable","iceberg:DeleteNamespace","iceberg:CommitTransaction"],"Resource":"*"}]}`),
	...
	"bucket-admin": []byte(`{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Action":["s3:GetObject","s3:HeadObject","s3:PutObject","s3:DeleteObject","s3:CopyObject","s3:ListBucket","s3:ListMultipartUploads","s3:AbortMultipartUpload","s3:GetBucketLocation","s3:GetBucketPolicy","s3:GetBucketVersioning","s3:PutBucketVersioning","s3:ListBucketVersions","s3:GetBucketObjectLockConfiguration","s3:GetObjectRetention","s3:PutObjectRetention","s3:GetObjectTagging","s3:PutObjectTagging","s3:DeleteObjectTagging","iceberg:GetCatalogConfig","iceberg:ListNamespaces","iceberg:LoadNamespace","iceberg:HeadNamespace","iceberg:CreateNamespace","iceberg:DeleteNamespace","iceberg:ListTables","iceberg:LoadTable","iceberg:HeadTable","iceberg:CreateTable","iceberg:CommitTable","iceberg:DeleteTable","iceberg:CommitTransaction"],"Resource":"*"}]}`),
}
