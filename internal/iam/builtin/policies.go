...
// S3 managed policies: readonly, readwrite, writeonly, bucket-admin.
...
var builtinDocs = map[string][]byte{
	// S3 managed policies.
	"readonly":     []byte(`{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Action":["s3:GetObject","s3:HeadObject","s3:ListBucket","s3:GetBucketLocation","s3:GetBucketVersioning","s3:ListBucketVersions","s3:GetBucketObjectLockConfiguration","s3:GetBucketLifecycleConfiguration","s3:GetObjectRetention","s3:GetObjectTagging"],"Resource":"*"}]}`),
	"readwrite":    []byte(`{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Action":["s3:GetObject","s3:HeadObject","s3:ListBucket","s3:GetBucketLocation","s3:GetBucketVersioning","s3:PutBucketVersioning","s3:ListBucketVersions","s3:GetBucketObjectLockConfiguration","s3:GetBucketLifecycleConfiguration","s3:GetObjectRetention","s3:PutObjectRetention","s3:PutObject","s3:DeleteObject","s3:CopyObject","s3:AbortMultipartUpload","s3:ListMultipartUploads","s3:GetObjectTagging","s3:PutObjectTagging","s3:DeleteObjectTagging"],"Resource":"*"}]}`),
	"writeonly":    []byte(`{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Action":["s3:PutObject","s3:PutBucketVersioning","s3:PutObjectRetention","s3:AbortMultipartUpload","s3:PutObjectTagging","s3:DeleteObjectTagging"],"Resource":"*"}]}`),
	"bucket-admin": []byte(`{"Version":"2012-10-17","Statement":[{"Effect":"Allow","Action":["s3:GetObject","s3:HeadObject","s3:PutObject","s3:DeleteObject","s3:CopyObject","s3:ListBucket","s3:ListMultipartUploads","s3:AbortMultipartUpload","s3:GetBucketLocation","s3:GetBucketPolicy","s3:GetBucketVersioning","s3:PutBucketVersioning","s3:ListBucketVersions","s3:GetBucketObjectLockConfiguration","s3:GetBucketLifecycleConfiguration","s3:PutBucketLifecycleConfiguration","s3:DeleteBucketLifecycleConfiguration","s3:GetObjectRetention","s3:PutObjectRetention","s3:GetObjectTagging","s3:PutObjectTagging","s3:DeleteObjectTagging"],"Resource":"*"}]}`),
}
