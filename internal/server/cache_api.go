...
// cacheStatus handles GET /api/cache/status. Reports the EC shard cache
// hit/miss counters + resident bytes so the operations dashboard can show
// whether the cache is doing useful work and how full it is.
